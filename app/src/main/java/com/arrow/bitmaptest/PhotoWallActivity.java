...
public class PhotoWallActivity extends AppCompatActivity implements AbsListView.OnScrollListener{
    ...
    private void initView() {
        ...
        mImageAdapter = new ImageAdapter(mUrList,this,mIsGridViewIdle,mCanGetBitmapFromNetWork);
